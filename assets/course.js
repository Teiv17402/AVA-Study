...
// Sau X giây thì cho phép user tự khẳng định "đã tua đến cuối"
const MANUAL_OVERRIDE_AFTER = 30; // giây
...
function updateTimerUI() {
  ...
  // Admin: luôn cho phép hoàn thành ngay
  if (admin) {
    timerEl.classList.add("ready");
